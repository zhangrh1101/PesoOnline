...
//    image = [image yy_imageByResizeToSize:CGSizeMake(image.size.width * scale, image.size.height * scale)];
...
{
    [self setImagePosition:postion spacing:spacing imageScale:1];
}
